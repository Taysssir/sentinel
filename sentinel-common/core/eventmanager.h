#ifndef MY_CORE_EVENT_H
#define MY_CORE_EVENT_H

#include "core/simplesignal.h"
...
namespace core
{
    ...
    public:
        virtual ~BaseReceiver() {
            for (auto connection : connections_) { auto &ptr = connection.first;
                if (!ptr.expired()) {
