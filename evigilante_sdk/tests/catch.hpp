...
#define INTERNAL_CHECK_THAT(arg, matcher, resultDisposition, macroName)                                                                                                                                                \
    ...
    {                                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                                              \
            ...
            __catchResult.setLhs(Catch::toString(arg)).setRhs(matcherAsString == Catch::Detail::unprintableString ? #matcher : matcherAsString).setOp("matches").setResultType(::Catch::Matchers::matcher.match(arg)); \
...
namespace Catch
{
    ...
    private:
        ...
        void printTotals(const Totals &totals) const
        {
            ...
            {
                Colour colour(Colour::ResultError);
                const std::string qualify_assertions_failed = totals.assertions.failed == totals.assertions.total() ? bothOrAll(totals.assertions.failed) : "";
